    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/public/**" , "/images/**", "/user/quickChat/**", "/user/chat/**", "/api/assessment/**" , "/api/escalation/**", "/api/care-journey", "/api/lifestyle", "/swagger-ui.html", "/v3/api-docs").permitAll()
